...
download_url = "https://github.com/zeromq/libzmq/archive/v$(version)/libzmq-$(version).tar.gz"
...
download: mkdir
	curl -L -o rpmbuild/SOURCES/libzmq-$(version).tar.gz $(download_url); 
